...
document.querySelector("#main-form").addEventListener("submit",(e) =>
{
    ...
    //const skills = document.querySelectorAll('.checkbox1:checked');
    //skills.forEach(skill => console.log(skill.value));
...
// for validations of email field
